...
On average, the maximum number of steps was taken in the interval `r maxtime`.
...
The mean number of steps per day is `r stepmean_all`.
The median number of steps per day is `r stepmedian_all`.
